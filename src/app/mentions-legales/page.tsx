...
export const metadata = {
    title: "Mentions Légales | Les Fuseaux Asseventois",
    description: "Informations légales et politique de confidentialité de l'association Les Fuseaux Asseventois.",
};
