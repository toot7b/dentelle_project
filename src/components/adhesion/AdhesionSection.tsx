...
import AdhesionBackground from "./AdhesionBackground";
...
export default function AdhesionSection() {
    ...
    useGSAP(() => {
        ...
        if (clouds && clouds.length > 0) {
            ...
            // Dérive continue vers la droite après l'entrée
            tl.call(() => {
                clouds.forEach((el, i) => {
                    gsap.to(el, {
                        x: "+=14",
                        duration: 14 + (i % 5) * 3,   // 14–26s, légère variation par nuage
                        ease: "sine.inOut",
                        repeat: -1,
                        yoyo: true,
                    });
        ...
        // ── Sous-titre ───────────────────────────────────────────
        tl.fromTo("[data-adhesion-subtitle]",
        ...
        // ── Collines ─────────────────────────────────────────────
        const hills = sectionRef.current?.querySelectorAll("[data-adhesion-hills]");
    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 container mx-auto px-6 md:px-16 flex flex-col items-center text-center">
                ...
                >
                    Passionné(e) par la dentelle aux fuseaux ? Rejoignez Les Fuseaux Asseventois et intégrez une communauté chaleureuse de dentellières au Château de Fillières.
                </p>
                <AdhesionForm />
            </div>

            {/* Collines vertes — transition vers le footer */}
            <div data-adhesion-hills className="absolute bottom-0 left-0 w-full pointer-events-none z-10">
                {/* Desktop */}
